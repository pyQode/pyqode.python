...
class Case:
    ...
    def run(self, editor):
        ...
        assert frontend.current_line_nbr(editor) == self.context.expected_line
        assert frontend.current_column_nbr(editor) == self.context.expected_column


@cwd_at('test/test_frontend/test_modes')
def collect_cases():
    cases = []
