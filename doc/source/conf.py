...
htmlhelp_basename = 'pyqode.python_doc'
...
latex_documents = [
  ('index', 'pyqode.python.tex', u'pyqode.python Documentation',
...
man_pages = [
    ('index', 'pyqode.python', u'pyqode.python Documentation',
     [u'Colin Duquesnoy'], 1)
]
...
texinfo_documents = [
  ('index', 'pyqode.python', u'pyqode.python Documentation',
   u'Colin Duquesnoy', 'pyqode.python', 'One line description of project.',
   'Miscellaneous'),
]
